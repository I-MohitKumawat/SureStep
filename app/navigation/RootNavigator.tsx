  ...
  return (
    ...
    >
      ...
      <HomeStack.Screen
        ...
        initialParams={initialRouteName === 'ProfileSetup' ? initialParams : undefined}
      />
...
export function RootNavigator({
  ...
  return <HomeStackNavigator initialRouteName={initialRouteName} initialParams={initialParams} />;
}
