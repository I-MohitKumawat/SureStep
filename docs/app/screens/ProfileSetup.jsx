        ...
        >
          <View style={[styles.card, { backgroundColor: theme.colors.surface, borderColor: theme.colors.borderSubtle }]}>
            ...
            <ProfileForm
              ...
              onSubmit={(draft) => {
                const nextScreen = draft.role === 'patient' ? 'PatientDashboard' : 'CaregiverDashboard';
                navigation.reset({
                  index: 0,
